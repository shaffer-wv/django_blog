...
from blogengine.views import CategoryListView, TagListView, PostMonthArchiveView
...
urlpatterns = patterns('',
	...
	# archives
	url(r'^(?P<year>\d{4})/(?P<month>[0-9]+)/$', PostMonthArchiveView.as_view(month_format = '%m'), name="archive_month"),
